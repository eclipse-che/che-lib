...
public class Evaluator {
  ...
  */
      ...
      if (argumentMatching == ARGUMENT_MATCHING.MATCH) {
        ...
        if (m == null) {
          ...
          throw new ExpressionException(
              "Multiple methods with name " + mm.name() + " matched to specified arguments. ");
        }
      }
    }
    return m;
  ...
  public ExpressionValue ternaryOperator(
      ExpressionValue testCondition, ExpressionValue value1, ExpressionValue value2) {
